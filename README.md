...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-ips-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8208&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ips-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ips` can be installed with:

```
conda install r-ips
```

It is possible to list all of the versions of `r-ips` available on your platform with:
